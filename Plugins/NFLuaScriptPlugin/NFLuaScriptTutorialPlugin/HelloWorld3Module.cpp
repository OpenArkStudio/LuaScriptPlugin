...
bool HelloWorld3Module::AfterInit()
{
	...
	m_pKernelModule->AddClassCallBack(NFrame::NPC::ThisName(), this, &HelloWorld3Module::OnClassCallBackEvent);
...
bool HelloWorld3Module::Execute()
{
    ...
    if (bTest)
    {
        ...
        NF_SHARE_PTR<NFIObject> pObject = m_pKernelModule->CreateObject(NFGUID(0, 10), 1, 0, NFrame::NPC::ThisName(), "Player_0_3", NFCDataList());
        if (nullptr == pObject)
        {
            return false;
        }
